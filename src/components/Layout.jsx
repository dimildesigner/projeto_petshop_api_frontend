...
export default function Layout({ children }) {
  ...
  const currentLabel =
    navItems.find((i) => i.path === location.pathname)?.label ?? "Petstock";
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-2.5 px-4 py-5 border-b border-stone-800">
        <LogoIcon />
        <span className="text-orange-500 font-medium text-base tracking-tight">
          Petstock
        </span>
      </div>
      ...
      <main className="flex-1 bg-stone-100 overflow-auto min-w-0">
        ...
        <header className="bg-white border-b border-stone-200 px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-stone-800 font-medium text-base">
              {currentLabel}
            </h1>
          </div>
